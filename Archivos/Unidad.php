      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php if($permiso[0]->alta == 1):?>
              <button class="btn btn-success" style="float: inline-end;" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i> Agregar unidad</button>
          <?php endif ?>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tablaperiodo" class="table table-bordered table-striped">
                ...
                <tbody v-for="unidad in unidades">
                <td>{{unidad.id_unidad}}</td>
                <td>{{unidad.unidad}}</td>
                <?php if($permiso[0]->edita == 1):?>
                <td><i class="fas fa-edit fa-lg" @click="findUnidad(unidad.id_unidad)" data-toggle="modal" data-target="#editModal"></i></td>
                <?php endif ?>
                <?php if($permiso[0]->baja == 1):?>
          ...
          <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <label for="Descripcion"><strong>Unidad</strong></label>
                    <input type="text" class="form-control" v-model="unidad" required>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="clearData">Cerrar</button>
          ...
          <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="addModal">Agregar unidad</h5>
                  <button type="button" class="close" data-dismiss="modal" @click="clearData" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" @click="clearData" data-dismiss="modal">Cerrar</button>
...
<script src="/jmdistributions/Hr/Vistas/js/Component/unidad.js"></script>
</body>
</html>