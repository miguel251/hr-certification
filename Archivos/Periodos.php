...
<body>
 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light bg-blue" >
  ...
  <div class="container-fluid" id="periodos">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4">
                            <label for="Periodo"><strong>Empleado</strong></label>
                            <select v-model="id_empleado" class="form-control" @change="findArea(id_empleado)">
                                <option value="0" disabled>Selecciona un empleado</option>
                                <option v-for="empleado in empleados" :value="empleado.id_empleado">{{empleado.nombre}}</option>
                            </select>
                        </div><!--/.col-4-->
                        <div class="col-4">
                            <label for="Periodo"><strong>Departamento</strong></label>
                            <select v-model="id_area" class="form-control" @change="findEmpleados(id_area)">
                                <option value="0" disabled>Selecciona un departamento</option>
                                <option v-for="area in areas" :value="area.id_area">{{area.nombre}}</option>
                                <option value="todos">Todos los empleados</option>
                            </select>
                        </div><!--/.col-4-->
                        <div class="col-4" v-if="showPeriodo">
...
<script src="/jmdistributions/Hr/Vistas/js/Component/periodos.js"></script>
</body>
</html>